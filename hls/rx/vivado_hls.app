<project xmlns="com.autoesl.autopilot.project" name="rx" top="rx_update">
    <files>
        ...
        <file name="rx/src/rx.cpp" sc="0" tb="false" cflags=""/>
        <file name="rx/src/rx.h" sc="0" tb="false" cflags=""/>
    </files>
    <includePaths/>
    <libraryPaths/>
    <Simulation>
