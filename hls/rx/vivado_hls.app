<project xmlns="com.autoesl.autopilot.project" name="rx" top="_sync_update">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="rx/src/serial_to_parallel.h" sc="0" tb="false" cflags=""/>
        <file name="rx/src/serial_to_parallel.cpp" sc="0" tb="false" cflags=""/>
